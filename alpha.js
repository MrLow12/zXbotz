...
const low = (await import("lowdb"))
   ...
   store.readFromFile('./zXsession/baileys_store.json')
    setInterval(() => {
	store.writeToFile('./zXsession/baileys_store.json')
}, 10000)
...
function uncache(module = '.') {
   ...
   console.log(chalk.bold.green(figlet.textSync('ZAKKIBOTZ', {
      font: 'Standard',
   ...
   logged()
   delay(100)
   console.log(color('Wait bang nunggu koneksi bot...', 'yellow'))
   ...
   const alpha = alphaConnect({
      ...
      browser: ['Bot By zakkiBotz', 'zakki gans', '1.0.0'],
      auth: state
   })
